...
class Subsession(BaseSubsession):
	...
	def set_groups(self):
		# Crear categoría de listas
		cat_lists = dict.fromkeys(Constants.category_names)
		for element in cat_lists:
			cat_lists[element] = []

		# clasificar a los jugadores en listas según sus elecciones
		for player in self.get_players():
		...
		# Los jugadores sabrán en qué grupos están
...
# Cada jugador escogerá una categoría:
...
# Todos tomarán la decisión de inversión para el cliente
...
# los clientes enviarán el mensaje a sus asesores:
...
# Payoffs:
	...
	# Campos de la obtención de riesgo dependiendo de la elección de cada agente
